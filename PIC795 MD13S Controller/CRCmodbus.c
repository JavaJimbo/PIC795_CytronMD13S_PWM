...
/*
* unsigned short CalculateModbusCRC( const unsigned char *input_str, size_t num_bytes );
*
* The function CalculateModbusCRC() calculates the 16 bits Modbus CRC in one pass for
