...
extern unsigned char PCAWrite4Bytes (unsigned char device, unsigned char Register, unsigned char data1, unsigned char data2, unsigned char data3, unsigned char data4);
...
extern unsigned char setPCA9685outputsFast (unsigned char device, unsigned short channel, unsigned short turnON, unsigned short turnOFF);
